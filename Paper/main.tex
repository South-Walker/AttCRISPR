...
We compare the performance of method in both spatial and temporal domain (without any hand-crafted biological features). 
...
In Table~\ref{Tab:01}, we annotate some properties of these baselines (with/without neural models, with/without hand-crafted feature)

\begin{table}[!t]
    \processtable{
    The naming convention code and brief description of the methods compared in our work\label{Tab:01}} 
    {\begin{tabular}{@{}lllll@{}}\toprule 
        Method & Code & Neural & Hand-crafted Feature & Description\\\midrule
        Linear$^*$ & row1 & No & No & row1\\
        Ridge$^*$ & row4 & No & No & row4\\
        XGBoost$^*$ & row1 & No & No & row1\\
        MLP$^*$ & row1 & Yes & No & row1\\
        DeepHF$^*$ & row1 & Yes & Yes & row1\\
        CRISPRpred(SEQ)$^{\#}$ & row1 & No & Yes & row1\\
        \botrule

...
\begin{enumerate}
    ...
    Some previous studies have used model based CNN to predict sgRNA on-target activity or off-target effect \citep{lin2018off-target,kim2018deep,chuai2018deepcrispr}. 

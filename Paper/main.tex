...
We use the conclusion of corresponding paper as the performance indicators of the model directly. 
...
\section{Results}
\begin{figure*}[!tpb]%figure4
    \centerline{\includegraphics[width=178mm]{baselinewithoutbiofeat.eps}}
...
Text
\begin{table}[!tpb]
    \processtable{wait2write\label{Tab:02}} 
    {\begin{tabular}{@{}llll@{}}\toprule
        ...
        \textbf{EnAC} & \textbf{0.868} & \textbf{0.859} & \textbf{0.862}\\
        CRISPRpred(SEQ) & 0.838 & 0.830 & 0.821\\
        \botrule
    \end{tabular}}\footnotesize\setlength{\parindent}{2em}{\emph{Note}: wait2write}
\end{table}

...
It is necessary to develope a method which can not only match deep learning based methods in performance, 
...
Furthermore, AttCRISPR has strong interpretability benefits from two attention modules, spatial and temporal attention modules. 

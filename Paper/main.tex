...
\begin{figure}[!tpb]%figure2
    \centerline{\includegraphics[scale=0.15]{newcnn.png}}
    \caption{Two categories of the deep learning models used in sgRNA related task. 
    (a) Model work in spatial domain. (b) Model work in temporal domain.}\label{fig:02}
\end{figure}
As Figure~1\vphantom{\ref{fig:02}} show,  
